...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Slidewhizard</title>
        <meta property="og:title" content="Slidewhizard" />
      </Helmet>
        ...
        <div className="home-hero">
          <div className="home-container07">
            <h1 className="home-text12">
              <span className="home-text13">Design Presentations</span>
              <br></br>
              <span className="home-text13">Using AI</span>
              <br></br>
            </h1>
      ...
      <div className="home-features">
        ...
        <div className="home-features1">
          <FeatureCard cardTitle="PPT generation"></FeatureCard>
          <FeatureCard imageSrc="/02.svg" cardTitle="Flexibility"></FeatureCard>
          <FeatureCard
            imageSrc="/03.svg"
            cardTitle="Layout Analysis"
          ></FeatureCard>
          <FeatureCard
            imageSrc="/04.svg"
            cardTitle="Multiple Designs"
          ></FeatureCard>
          <FeatureCard
            imageSrc="/05.svg"
        ...
        <div className="home-container08">
          <div className="home-container09">
            ...
            <div className="home-container10">
              <TestimonialsCard
                src="/logo-1.svg"
                text="I can't believe how much time and effort this automatic PPT generation website has saved me! As a busy professional, creating presentations used to be a time-consuming chore, but now it's a breeze. The templates are sleek, and the content suggestions are spot on."
                text1="Jane Cooper"
                text2=""
                imageSrc="/logo-4.svg"
              ></TestimonialsCard>
          ...
          <div className="home-container11">
            ...
            <div className="home-container13">
              <TestimonialsCard
                text="As a student, I often struggled with creating visually appealing presentations. That's until I discovered this automatic PPT generation website. It's been a game-changer for my academic work. "
      ...
      <div className="home-footer">
        <footer className="home-container24">
          ...
          <div className="home-container25">
            <span className="home-text35">About</span>
            <span className="home-text36">Features</span>
            <span className="home-text37">Pricing</span>
            <span className="home-text38">Careers</span>
            <span className="home-text39">Help</span>
            <span className="home-text40">Privacy Policy</span>
          </div>
          <div className="home-divider2"></div>
          <div className="home-container26">
            <span className="home-text41 Body2">
              © 2020 Slidewhizard UI Kit. All rights reserved
            </span>
